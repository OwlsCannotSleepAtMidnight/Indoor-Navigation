...
public class F1SubBottomFloor extends Floor{
    //ArrayList<Vertex> B1_vertex= new ArrayList();
    public F1SubBottomFloor(int stair) {
        super(stair);
    ...
    public void InitializeVertex() {
        ...
        _path.AddVertex(F1SubBottom.ES3.ordinal(), new Vertex("ES3" , 0.3298,0.3151 , _stair));
        ...
        _path.AddVertex(F1SubBottom.S5.ordinal(), new Vertex("S5" , 0.3606,0.2497 , _stair));
        _path.AddVertex(F1SubBottom.S6.ordinal(), new Vertex("S6" , 0.3991,0.2497 , _stair));
        _path.AddVertex(F1SubBottom.Q1.ordinal(), new Vertex("Q1" , 0.3799,0.1746 , _stair));
        _path.AddVertex(F1SubBottom.S7.ordinal(), new Vertex("S7" , 0.6012,0.2497 , _stair));
        _path.AddVertex(F1SubBottom.S8.ordinal(), new Vertex("S8" , 0.6358,0.2497 , _stair));
        _path.AddVertex(F1SubBottom.Q2.ordinal(), new Vertex("Q2" , 0.6185,0.1746 , _stair));
        _path.AddVertex(F1SubBottom.W6.ordinal(), new Vertex("W6" , 0.7493,0.3344 , _stair));
        _path.AddVertex(F1SubBottom.WT6.ordinal(), new Vertex("WT6" , 0.7263,0.3498 , _stair));
        _path.AddVertex(F1SubBottom.EL4.ordinal(), new Vertex("EL4" , 0.6916,0.3344 , _stair));
        _path.AddVertex(F1SubBottom.ES4.ordinal(), new Vertex("ES4" , 0.6666,0.3151 , _stair));
        ...
        _path.AddVertex(F1SubBottom.S2.ordinal(), new Vertex("S2" , 0.3991,0.0746 , _stair));
        _path.AddVertex(F1SubBottom.D2.ordinal(), new Vertex("D2" , 0.4992,0.0419 , _stair));
        _path.AddVertex(F1SubBottom.S3.ordinal(), new Vertex("S3" , 0.6012,0.0746 , _stair));
        _path.AddVertex(F1SubBottom.S4.ordinal(), new Vertex("S4" , 0.6358,0.0746 , _stair));
        _path.AddVertex(F1SubBottom.D3.ordinal(), new Vertex("D3" , 0.7378,0.0419 , _stair));
        ...
        _path.AddVertex(F1SubBottom.U3.ordinal(), new Vertex("U3" , 0.3991,0.3594 , _stair));
        _path.AddVertex(F1SubBottom.X3.ordinal(), new Vertex("X3" , 0.6012,0.3594 , _stair));
        ...
        _path.AddVertex(F1SubBottom.T3.ordinal(), new Vertex("T3" , 0.3991,0.2882 , _stair));
        _path.AddVertex(F1SubBottom.V3.ordinal(), new Vertex("V3" , 0.4992,0.2882 , _stair));
        _path.AddVertex(F1SubBottom.w3.ordinal(), new Vertex("w3" , 0.6012,0.2882 , _stair));
        ...
        _path.AddVertex(F1SubBottom.C4.ordinal(), new Vertex("C4" , 0.7263,0.2882 , _stair));
        ...
        _path.AddVertex(F1SubBottom.N3.ordinal(), new Vertex("N3" , 0.3799,0.1535 , _stair));
        _path.AddVertex(F1SubBottom.e4.ordinal(), new Vertex("e4" , 0.4992,0.1535 , _stair));
        _path.AddVertex(F1SubBottom.M3.ordinal(), new Vertex("M3" , 0.6185,0.1535 , _stair));
        ...
        _path.AddVertex(F1SubBottom.A3.ordinal(), new Vertex("A3" , 0.3799,0.0900 , _stair));
        _path.AddVertex(F1SubBottom.b3.ordinal(), new Vertex("b3" , 0.3991,0.0900 , _stair));
        _path.AddVertex(F1SubBottom.C3.ordinal(), new Vertex("C3" , 0.4992,0.0900 , _stair));
        _path.AddVertex(F1SubBottom.d3.ordinal(), new Vertex("d3" , 0.6012,0.0900 , _stair));
        _path.AddVertex(F1SubBottom.e3.ordinal(), new Vertex("e3" , 0.6185,0.0900 , _stair));
        _path.AddVertex(F1SubBottom.F3.ordinal(), new Vertex("F3" , 0.6358,0.0900 , _stair));
        ...
        _path.AddVertex(F1SubBottom.EB1.ordinal(), new Vertex("EB1", 0.1836,0.0900, _stair) );
        _path.AddVertex(F1SubBottom.EB2.ordinal(), new Vertex("EB2", 0.3087,0.0900, _stair));
        _path.AddVertex(F1SubBottom.EB3.ordinal(), new Vertex("EB3", 0.4511,0.0900, _stair) );
        _path.AddVertex(F1SubBottom.EB4.ordinal(), new Vertex("EB4", 0.5473,0.0900, _stair) );
        _path.AddVertex(F1SubBottom.EB5.ordinal(), new Vertex("EB5", 0.6916,0.0900, _stair) );
        _path.AddVertex(F1SubBottom.EB6.ordinal(), new Vertex("EB6", 0.6916,0.1535, _stair) );
        _path.AddVertex(F1SubBottom.EB7.ordinal(), new Vertex ("EB7", 0.5473,0.1535, _stair));
        _path.AddVertex(F1SubBottom.EB8.ordinal(), new Vertex("EB8", 0.4511,0.1535, _stair) );
        _path.AddVertex(F1SubBottom.EB9.ordinal(), new Vertex("EB9", 0.3087,0.1535, _stair) );
        _path.AddVertex(F1SubBottom.EB10.ordinal(), new Vertex("EB10",0.4511,0.2497, _stair) );
        _path.AddVertex(F1SubBottom.EB11.ordinal(), new Vertex("EB11",0.5473,0.2497, _stair) );
        _path.AddVertex(F1SubBottom.EB12.ordinal(), new Vertex("EB12",0.5473,0.2882, _stair) );
        _path.AddVertex(F1SubBottom.EB13.ordinal(), new Vertex("EB13",0.4511,0.2882, _stair) );
    ...
    public void InitializeEdge() {
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.N3.ordinal()), _path.GetVertex(F1SubBottom.A3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.N3.ordinal()).GetY()-_path.GetVertex(F1SubBottom.A3.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.Q1.ordinal()), _path.GetVertex(F1SubBottom.N3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.Q1.ordinal()).GetY()-_path.GetVertex(F1SubBottom.N3.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.T3.ordinal()), _path.GetVertex(F1SubBottom.S6.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.T3.ordinal()).GetY()-_path.GetVertex(F1SubBottom.S6.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.X3.ordinal()), _path.GetVertex(F1SubBottom.Y3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.X3.ordinal()).GetY() - _path.GetVertex(F1SubBottom.Y3.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.Y3.ordinal()), _path.GetVertex(F1SubBottom.U3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.Y3.ordinal()).GetX()-_path.GetVertex(F1SubBottom.U3.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB1.ordinal()), _path.GetVertex(F1SubBottom.w2.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB1.ordinal()).GetX() - _path.GetVertex(F1SubBottom.w2.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB1.ordinal()), _path.GetVertex(F1SubBottom.X2.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB1.ordinal()).GetX()-_path.GetVertex(F1SubBottom.X2.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB2.ordinal()), _path.GetVertex(F1SubBottom.Y2.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB2.ordinal()).GetX() - _path.GetVertex(F1SubBottom.Y2.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB2.ordinal()), _path.GetVertex(F1SubBottom.Z2.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB2.ordinal()).GetX()-_path.GetVertex(F1SubBottom.Z2.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB3.ordinal()), _path.GetVertex(F1SubBottom.b3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB3.ordinal()).GetX() - _path.GetVertex(F1SubBottom.b3.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB3.ordinal()), _path.GetVertex(F1SubBottom.C3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB3.ordinal()).GetX()-_path.GetVertex(F1SubBottom.C3.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB4.ordinal()), _path.GetVertex(F1SubBottom.C3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB4.ordinal()).GetX() - _path.GetVertex(F1SubBottom.C3.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB4.ordinal()), _path.GetVertex(F1SubBottom.d3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB4.ordinal()).GetX()-_path.GetVertex(F1SubBottom.d3.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB5.ordinal()), _path.GetVertex(F1SubBottom.F3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB5.ordinal()).GetX() - _path.GetVertex(F1SubBottom.F3.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB5.ordinal()), _path.GetVertex(F1SubBottom.G3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB5.ordinal()).GetX()-_path.GetVertex(F1SubBottom.G3.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB6.ordinal()), _path.GetVertex(F1SubBottom.M3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB6.ordinal()).GetX() - _path.GetVertex(F1SubBottom.M3.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB6.ordinal()), _path.GetVertex(F1SubBottom.L3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB6.ordinal()).GetX() - _path.GetVertex(F1SubBottom.L3.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB7.ordinal()), _path.GetVertex(F1SubBottom.e4.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB7.ordinal()).GetX() - _path.GetVertex(F1SubBottom.e4.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB7.ordinal()), _path.GetVertex(F1SubBottom.M3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB7.ordinal()).GetX()-_path.GetVertex(F1SubBottom.M3.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB8.ordinal()), _path.GetVertex(F1SubBottom.N3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB8.ordinal()).GetX() - _path.GetVertex(F1SubBottom.N3.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB8.ordinal()), _path.GetVertex(F1SubBottom.e4.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB8.ordinal()).GetX()-_path.GetVertex(F1SubBottom.e4.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB9.ordinal()), _path.GetVertex(F1SubBottom.O3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB9.ordinal()).GetX() - _path.GetVertex(F1SubBottom.O3.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB9.ordinal()), _path.GetVertex(F1SubBottom.N3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB9.ordinal()).GetX()-_path.GetVertex(F1SubBottom.N3.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB10.ordinal()), _path.GetVertex(F1SubBottom.S6.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB10.ordinal()).GetX() - _path.GetVertex(F1SubBottom.S6.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB11.ordinal()), _path.GetVertex(F1SubBottom.S7.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB11.ordinal()).GetX() - _path.GetVertex(F1SubBottom.S7.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB12.ordinal()), _path.GetVertex(F1SubBottom.V3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB12.ordinal()).GetX() - _path.GetVertex(F1SubBottom.V3.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB12.ordinal()), _path.GetVertex(F1SubBottom.w3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB12.ordinal()).GetX() - _path.GetVertex(F1SubBottom.w3.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubBottom.EB13.ordinal()), _path.GetVertex(F1SubBottom.V3.ordinal()), Math.abs(_path.GetVertex(F1SubBottom.EB13.ordinal()).GetX() - _path.GetVertex(F1SubBottom.V3.ordinal()).GetX()));
