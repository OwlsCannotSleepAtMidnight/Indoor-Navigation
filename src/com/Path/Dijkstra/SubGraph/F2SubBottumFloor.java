...
public class F2SubBottumFloor extends Floor{
    //ArrayList<Vertex> B1_vertex= new ArrayList();
    public F2SubBottumFloor(int stair) {
        super(stair);
    ...
    public void InitializeVertex() {
        ...
        _path.AddVertex(F2SubBottom.W5.ordinal(), new Vertex("W5" , 0.2432, 0.3324, _stair));
        _path.AddVertex(F2SubBottom.EL3.ordinal(), new Vertex("EL3" , 0.3087, 0.3344, _stair));
        _path.AddVertex(F2SubBottom.ES3.ordinal(), new Vertex("ES3" , 0.3279, 0.3094, _stair));
        _path.AddVertex(F2SubBottom.S9.ordinal(), new Vertex("S9" , 0.2432, 0.2593, _stair));
        _path.AddVertex(F2SubBottom.S10.ordinal(), new Vertex("S10" , 0.2432, 0.2247, _stair));
        _path.AddVertex(F2SubBottom.S11.ordinal(), new Vertex("S11" , 0.2432, 0.1843, _stair));
        _path.AddVertex(F2SubBottom.S12.ordinal(), new Vertex("S12" , 0.1836, 0.1535, _stair));
        _path.AddVertex(F2SubBottom.S5.ordinal(), new Vertex("S5" , 0.3587, 0.2574, _stair));
        _path.AddVertex(F2SubBottom.S6.ordinal(), new Vertex("S6" , 0.3953, 0.2574, _stair));
        _path.AddVertex(F2SubBottom.Q1.ordinal(), new Vertex("Q1" , 0.3722, 0.1746, _stair));
        _path.AddVertex(F2SubBottom.S7.ordinal(), new Vertex("S7" , 0.5973, 0.2574, _stair));
        _path.AddVertex(F2SubBottom.S8.ordinal(), new Vertex("S8" , 0.6358, 0.2574, _stair));
        _path.AddVertex(F2SubBottom.Q2.ordinal(), new Vertex("Q2" , 0.6223, 0.1746, _stair));
        _path.AddVertex(F2SubBottom.W6.ordinal(), new Vertex("W6" , 0.7667, 0.3324, _stair));
        _path.AddVertex(F2SubBottom.WT6.ordinal(), new Vertex("WT6" , 0.7423, 0.3498, _stair));
        _path.AddVertex(F2SubBottom.EL4.ordinal(), new Vertex("EL4" , 0.6916, 0.3344, _stair));
        _path.AddVertex(F2SubBottom.ES4.ordinal(), new Vertex("ES4" , 0.6666, 0.3094, _stair));
        _path.AddVertex(F2SubBottom.S13.ordinal(), new Vertex("S13" , 0.7667, 0.2593, _stair));
        _path.AddVertex(F2SubBottom.S14.ordinal(), new Vertex("S14" , 0.7667, 0.2247, _stair));
        _path.AddVertex(F2SubBottom.S15.ordinal(), new Vertex("S15" , 0.7667, 0.1843, _stair));
        ...
        _path.AddVertex(F2SubBottom.S2.ordinal(), new Vertex("S2" , 0.4010, 0.0746, _stair));
        _path.AddVertex(F2SubBottom.D2.ordinal(), new Vertex("D2" , 0.4953, 0.0419, _stair));
        _path.AddVertex(F2SubBottom.S3.ordinal(), new Vertex("S3" , 0.5993, 0.0746, _stair));
        _path.AddVertex(F2SubBottom.S4.ordinal(), new Vertex("S4" , 0.6339, 0.0746, _stair));
        _path.AddVertex(F2SubBottom.D3.ordinal(), new Vertex("D3" , 0.7378, 0.0361, _stair));
        ...
        _path.AddVertex(F2SubBottom.A3.ordinal(), new Vertex("A3" , 0.4953, 0.2959, _stair));
        _path.AddVertex(F2SubBottom.H3.ordinal(), new Vertex("H3" , 0.2432, 0.2959, _stair));
        ...
        _path.AddVertex(F2SubBottom.d3.ordinal(), new Vertex("d3" , 0.3587, 0.2959, _stair));
        _path.AddVertex(F2SubBottom.c3.ordinal(), new Vertex("c3" , 0.3760, 0.2959, _stair));
        _path.AddVertex(F2SubBottom.B3.ordinal(), new Vertex("B3" , 0.3953, 0.2959, _stair));
        _path.AddVertex(F2SubBottom.Z2.ordinal(), new Vertex("Z2" , 0.5973, 0.2959, _stair));
        ...
        _path.AddVertex(F2SubBottom.U2.ordinal(), new Vertex("U2" , 0.7423, 0.2959, _stair));
        _path.AddVertex(F2SubBottom.T2.ordinal(), new Vertex("T2" , 0.7667, 0.2959, _stair));
        _path.AddVertex(F2SubBottom.R2.ordinal(), new Vertex("R2" , 0.2432, 0.1535, _stair));
        _path.AddVertex(F2SubBottom.s2.ordinal(), new Vertex("s2" , 0.3722, 0.1535, _stair));
        _path.AddVertex(F2SubBottom.K2.ordinal(), new Vertex("K2" , 0.4953, 0.1535, _stair));
        _path.AddVertex(F2SubBottom.J2.ordinal(), new Vertex("J2" , 0.6223, 0.1535, _stair));
        _path.AddVertex(F2SubBottom.F4.ordinal(), new Vertex("F4" , 0.7667, 0.1535, _stair));
        ...
        _path.AddVertex(F2SubBottom.O2.ordinal(), new Vertex("O2" , 0.2432, 0.0900, _stair));
        ...
        _path.AddVertex(F2SubBottom.L2.ordinal(), new Vertex("L2" , 0.4010, 0.0900, _stair));
        _path.AddVertex(F2SubBottom.I2.ordinal(), new Vertex("I2" , 0.4953, 0.0900, _stair));
        _path.AddVertex(F2SubBottom.H2.ordinal(), new Vertex("H2" , 0.5993, 0.0900, _stair));
        _path.AddVertex(F2SubBottom.G2.ordinal(), new Vertex("G2" , 0.6339, 0.0900, _stair));
        _path.AddVertex(F2SubBottom.F2.ordinal(), new Vertex("F2" , 0.7378, 0.0900, _stair));
        _path.AddVertex(F2SubBottom.e2.ordinal(), new Vertex("e2" , 0.7667, 0.0900, _stair));
