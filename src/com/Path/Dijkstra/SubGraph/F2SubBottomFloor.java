...
public class F2SubBottomFloor extends Floor{
    ...
    public void InitializeEdge() {
        ...
        _path.AddRoute(_path.GetVertex(F2SubBottom.EB5.ordinal()), _path.GetVertex(F2SubBottom.EB7.ordinal()), Math.abs(_path.GetVertex(F2SubBottom.EB5.ordinal()).GetY() - _path.GetVertex(F2SubBottom.EB7.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F2SubBottom.EB6.ordinal()), _path.GetVertex(F2SubBottom.S16.ordinal()), Math.abs(_path.GetVertex(F2SubBottom.EB6.ordinal()).GetY() - _path.GetVertex(F2SubBottom.S16.ordinal()).GetY()));
