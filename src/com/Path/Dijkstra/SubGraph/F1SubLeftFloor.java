...
public class F1SubLeftFloor extends Floor{
    ...
    public void InitializeVertex() {
        _path.AddVertex(F1SubLeft.E9.ordinal(), new Vertex("E9" , 0.4395, 0.9675, _stair));
        _path.AddVertex(F1SubLeft.WT11.ordinal(), new Vertex("WT11" , 0.3799, 0.9559, _stair));
        _path.AddVertex(F1SubLeft.E8.ordinal(), new Vertex("E8" , 0.3183, 0.9675, _stair));
        _path.AddVertex(F1SubLeft.E7.ordinal(), new Vertex("E7" , 0.1990, 0.9713, _stair));
        _path.AddVertex(F1SubLeft.EL7.ordinal(), new Vertex("EL7" , 0.1432, 0.902, _stair));
        _path.AddVertex(F1SubLeft.ES7.ordinal(), new Vertex("ES7" , 0.1182, 0.9155, _stair));
        _path.AddVertex(F1SubLeft.W7.ordinal(), new Vertex("W7" , 0.0604, 0.9386, _stair));
        _path.AddVertex(F1SubLeft.WT9.ordinal(), new Vertex("WT9" , 0.0450, 0.9309, _stair));
        _path.AddVertex(F1SubLeft.E6.ordinal(), new Vertex("E6" , 0.0316, 0.0836, _stair));
        ...
        _path.AddVertex(F1SubLeft.B2.ordinal(), new Vertex("B2" , 0.3279, 0.5691, _stair));
        _path.AddVertex(F1SubLeft.B3.ordinal(), new Vertex("B3" , 0.4491, 0.6288, _stair));
        _path.AddVertex(F1SubLeft.Z3.ordinal(), new Vertex("Z3" , 0.4992, 0.3806, _stair));
        _path.AddVertex(F1SubLeft.M1.ordinal(), new Vertex("M1" , 0.4992, 0.4152, _stair));
        ...
        _path.AddVertex(F1SubLeft.J1.ordinal(), new Vertex("J1" , 0.4491, 0.6942, _stair));
        ...
        _path.AddVertex(F1SubLeft.F4.ordinal(), new Vertex("F4" , 0.1432, 0.6019, _stair));
        _path.AddVertex(F1SubLeft.G4.ordinal(), new Vertex("G4" , 0.1432, 0.4210, _stair));
        _path.AddVertex(F1SubLeft.P.ordinal(), new Vertex("P" , 0.0604, 0.6019, _stair));
        _path.AddVertex(F1SubLeft.J.ordinal(), new Vertex("J" , 0.0604, 0.0316, _stair));
    ...
    public void InitializeEdge() {
        ...
        _path.AddRoute(_path.GetVertex(F1SubLeft.F4.ordinal()), _path.GetVertex(F1SubLeft.EL7.ordinal()), Math.abs(_path.GetVertex(F1SubLeft.F4.ordinal()).GetY()-_path.GetVertex(F1SubLeft.EL7.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubLeft.J.ordinal()), _path.GetVertex(F1SubLeft.W3.ordinal()), Math.abs(_path.GetVertex(F1SubLeft.J.ordinal()).GetY()-_path.GetVertex(F1SubLeft.W3.ordinal()).GetY()));
        _path.AddRoute(_path.GetVertex(F1SubLeft.K.ordinal()), _path.GetVertex(F1SubLeft.B.ordinal()), Math.abs(_path.GetVertex(F1SubLeft.K.ordinal()).GetY()-_path.GetVertex(F1SubLeft.B.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubLeft.EL7.ordinal()), _path.GetVertex(F1SubLeft.F4.ordinal()), Math.abs(_path.GetVertex(F1SubLeft.EL7.ordinal()).GetY()-_path.GetVertex(F1SubLeft.F4.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubLeft.W3.ordinal()), _path.GetVertex(F1SubLeft.J.ordinal()), Math.abs(_path.GetVertex(F1SubLeft.W3.ordinal()).GetY()-_path.GetVertex(F1SubLeft.J.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubLeft.B.ordinal()), _path.GetVertex(F1SubLeft.K.ordinal()), Math.abs(_path.GetVertex(F1SubLeft.B.ordinal()).GetY()-_path.GetVertex(F1SubLeft.K.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubLeft.G4.ordinal()), _path.GetVertex(F1SubLeft.Z.ordinal()), Math.abs(_path.GetVertex(F1SubLeft.G4.ordinal()).GetX()-_path.GetVertex(F1SubLeft.Z.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubLeft.R.ordinal()), _path.GetVertex(F1SubLeft.G4.ordinal()), Math.abs(_path.GetVertex(F1SubLeft.R.ordinal()).GetX()-_path.GetVertex(F1SubLeft.G4.ordinal()).GetX()));
