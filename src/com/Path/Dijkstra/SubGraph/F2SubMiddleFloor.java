...
public class F2SubMiddleFloor extends Floor{
    //ArrayList<Vertex> B1_vertex= new ArrayList();
    public F2SubMiddleFloor(int stair) {
        super(stair);
    ...
    public void InitializeVertex() {
        ...
        _path.AddVertex(F2SubCenter.SC1.ordinal(), new Vertex("SC1" , 0.1971, 0.5056, _stair));
        _path.AddVertex(F2SubCenter.SC2.ordinal(), new Vertex("SC2" , 0.4953, 0.8039, _stair));
        ...
        _path.AddVertex(F2SubCenter.X3.ordinal(), new Vertex("X3" , 0.4953, 0.7520, _stair));
        ...
        _path.AddVertex(F2SubCenter.P3.ordinal(), new Vertex("P3" , 0.4953, 0.6019, _stair));
        ...
        _path.AddVertex(F2SubCenter.J3.ordinal(), new Vertex("J3" , 0.4953, 0.3806, _stair));
