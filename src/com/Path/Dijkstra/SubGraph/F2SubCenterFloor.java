...
public class F2SubCenterFloor extends Floor{
    ...
    public void InitializeEdge() {
        ...
        _path.AddRoute(_path.GetVertex(F2SubCenter.EM10.ordinal()), _path.GetVertex(F2SubCenter.SC3.ordinal()), Math.abs(_path.GetVertex(F2SubCenter.EM10.ordinal()).GetX()-_path.GetVertex(F2SubCenter.SC3.ordinal()).GetX()));
