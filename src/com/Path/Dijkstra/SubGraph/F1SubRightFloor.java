...
public class F1SubRightFloor extends Floor{
    ...
    public void InitializeVertex() {
        ...
        _path.AddVertex(F1SubRight.S24.ordinal(), new Vertex("S24" , 0.8186, 0.3960, _stair));
        ...
        _path.AddVertex(F1SubRight.W4.ordinal(), new Vertex("W4" , 0.9283, 0.1920, _stair));
        _path.AddVertex(F1SubRight.E18.ordinal(), new Vertex("E18" , 0.9630, 0.2632, _stair));
        _path.AddVertex(F1SubRight.WT4.ordinal(), new Vertex("WT4" , 0.9514, 0.3248, _stair));
        _path.AddVertex(F1SubRight.E17.ordinal(), new Vertex("E17" , 0.9630, 0.3844, _stair));
        _path.AddVertex(F1SubRight.E16.ordinal(), new Vertex("E16" , 0.9630, 0.5018, _stair));
        _path.AddVertex(F1SubRight.E15.ordinal(), new Vertex("E15" , 0.9630, 0.6230, _stair));
        _path.AddVertex(F1SubRight.WT8.ordinal(), new Vertex("WT8" , 0.9514, 0.6769, _stair));
        _path.AddVertex(F1SubRight.EL14.ordinal(), new Vertex("EL14" , 0.9630, 0.7423, _stair));
        _path.AddVertex(F1SubRight.E13.ordinal(), new Vertex("E13" , 0.9630, 0.8616, _stair));
        _path.AddVertex(F1SubRight.WT10.ordinal(), new Vertex("WT10" , 0.9514, 0.9039, _stair));
        _path.AddVertex(F1SubRight.W8.ordinal(), new Vertex("W8" , 0.9283, 0.9039, _stair));
        _path.AddVertex(F1SubRight.ES8.ordinal(), new Vertex("ES8" , 0.8764, 0.9117, _stair));
        _path.AddVertex(F1SubRight.EL8.ordinal(), new Vertex("EL8" , 0.8552, 0.9559, _stair));
        _path.AddVertex(F1SubRight.E12.ordinal(), new Vertex("E12" , 0.7975, 0.9675, _stair));
        _path.AddVertex(F1SubRight.E11.ordinal(), new Vertex("E11" , 0.6782, 0.9675, _stair));
        _path.AddVertex(F1SubRight.WT12.ordinal(), new Vertex("WT12" , 0.6166, 0.9559, _stair));
        _path.AddVertex(F1SubRight.E10.ordinal(), new Vertex("E10" , 0.5625, 0.9675, _stair));
        ...
        _path.AddVertex(F1SubRight.B5.ordinal(), new Vertex("B5" , 0.6685, 0.5691, _stair));
        ...
        _path.AddVertex(F1SubRight.M1.ordinal(), new Vertex("M1" , 0.4992, 0.4152, _stair));
        ...
        _path.AddVertex(F1SubRight.J2.ordinal(), new Vertex("J2" , 0.9283, 0.8616, _stair));
        ...
        _path.AddVertex(F1SubRight.F2.ordinal(), new Vertex("F2" , 0.9283, 0.6769, _stair));
        _path.AddVertex(F1SubRight.b2.ordinal(), new Vertex("b2" , 0.9283, 0.6230, _stair));
        ...
        _path.AddVertex(F1SubRight.T1.ordinal(), new Vertex("T1" , 0.9283, 0.4152, _stair));
        _path.AddVertex(F1SubRight.U1.ordinal(), new Vertex("U1" , 0.9283, 0.3844, _stair));
        ...
        _path.AddVertex(F1SubRight.s1.ordinal(), new Vertex("s1" , 0.8552, 0.4152, _stair));
        _path.AddVertex(F1SubRight.R1.ordinal(), new Vertex("R1" , 0.7423, 0.4152, _stair));
        _path.AddVertex(F1SubRight.q1.ordinal(), new Vertex("q1" , 0.5973, 0.4152, _stair));
        _path.AddVertex(F1SubRight.C2.ordinal(), new Vertex("C2" , 0.8552, 0.6019, _stair));
        ...
        _path.AddVertex(F1SubRight.J4.ordinal(), new Vertex("J4" , 0.6685, 0.6019, _stair));
    ...
    public void InitializeEdge() {
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.W4.ordinal()), _path.GetVertex(F1SubRight.Y1.ordinal()), Math.abs(_path.GetVertex(F1SubRight.W4.ordinal()).GetY()-_path.GetVertex(F1SubRight.Y1.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.E15.ordinal()), _path.GetVertex(F1SubRight.EL14.ordinal()), Math.abs(_path.GetVertex(F1SubRight.E15.ordinal()).GetY()-_path.GetVertex(F1SubRight.EL14.ordinal()).GetY()));
        _path.AddRoute(_path.GetVertex(F1SubRight.WT8.ordinal()), _path.GetVertex(F1SubRight.WT10.ordinal()), Math.abs(_path.GetVertex(F1SubRight.WT8.ordinal()).GetY()-_path.GetVertex(F1SubRight.WT10.ordinal()).GetY()));
        _path.AddRoute(_path.GetVertex(F1SubRight.EL14.ordinal()), _path.GetVertex(F1SubRight.E13.ordinal()), Math.abs(_path.GetVertex(F1SubRight.EL14.ordinal()).GetY()-_path.GetVertex(F1SubRight.E13.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.K1.ordinal()), _path.GetVertex(F1SubRight.I.ordinal()), Math.abs(_path.GetVertex(F1SubRight.K1.ordinal()).GetY()-_path.GetVertex(F1SubRight.I.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.J2.ordinal()), _path.GetVertex(F1SubRight.W8.ordinal()), Math.abs(_path.GetVertex(F1SubRight.J2.ordinal()).GetY()-_path.GetVertex(F1SubRight.W8.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.E17.ordinal()), _path.GetVertex(F1SubRight.E18.ordinal()), Math.abs(_path.GetVertex(F1SubRight.E17.ordinal()).GetY()-_path.GetVertex(F1SubRight.E18.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.EL14.ordinal()), _path.GetVertex(F1SubRight.E15.ordinal()), Math.abs(_path.GetVertex(F1SubRight.EL14.ordinal()).GetY()-_path.GetVertex(F1SubRight.E15.ordinal()).GetY()));
        _path.AddRoute(_path.GetVertex(F1SubRight.E13.ordinal()), _path.GetVertex(F1SubRight.EL14.ordinal()), Math.abs(_path.GetVertex(F1SubRight.E13.ordinal()).GetY()-_path.GetVertex(F1SubRight.EL14.ordinal()).GetY()));
        _path.AddRoute(_path.GetVertex(F1SubRight.WT10.ordinal()), _path.GetVertex(F1SubRight.WT8.ordinal()), Math.abs(_path.GetVertex(F1SubRight.WT10.ordinal()).GetY()-_path.GetVertex(F1SubRight.WT8.ordinal()).GetY()));
        _path.AddRoute(_path.GetVertex(F1SubRight.W8.ordinal()), _path.GetVertex(F1SubRight.J2.ordinal()), Math.abs(_path.GetVertex(F1SubRight.W8.ordinal()).GetY()-_path.GetVertex(F1SubRight.J2.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.I.ordinal()), _path.GetVertex(F1SubRight.K1.ordinal()), Math.abs(_path.GetVertex(F1SubRight.I.ordinal()).GetY()-_path.GetVertex(F1SubRight.K1.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.Y1.ordinal()), _path.GetVertex(F1SubRight.W4.ordinal()), Math.abs(_path.GetVertex(F1SubRight.Y1.ordinal()).GetY()-_path.GetVertex(F1SubRight.W4.ordinal()).GetY()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.E10.ordinal()), _path.GetVertex(F1SubRight.E11.ordinal()), Math.abs(_path.GetVertex(F1SubRight.E10.ordinal()).GetX()-_path.GetVertex(F1SubRight.E11.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.S37.ordinal()), _path.GetVertex(F1SubRight.S40.ordinal()), Math.abs(_path.GetVertex(F1SubRight.S37.ordinal()).GetX()-_path.GetVertex(F1SubRight.S40.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubRight.S38.ordinal()), _path.GetVertex(F1SubRight.S41.ordinal()), Math.abs(_path.GetVertex(F1SubRight.S38.ordinal()).GetX()-_path.GetVertex(F1SubRight.S41.ordinal()).GetX()));
        _path.AddRoute(_path.GetVertex(F1SubRight.S39.ordinal()), _path.GetVertex(F1SubRight.S42.ordinal()), Math.abs(_path.GetVertex(F1SubRight.S39.ordinal()).GetX()-_path.GetVertex(F1SubRight.S42.ordinal()).GetX()));
        ...
        _path.AddRoute(_path.GetVertex(F1SubRight.M2.ordinal()), _path.GetVertex(F1SubRight.L2.ordinal()), Math.abs(_path.GetVertex(F1SubRight.M2.ordinal()).GetX()-_path.GetVertex(F1SubRight.L2.ordinal()).GetX()));
